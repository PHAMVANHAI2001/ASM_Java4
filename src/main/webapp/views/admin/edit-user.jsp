			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div
						...
						<h1 class="h3 mb-0 text-gray-800">Thêm/Xóa/Sửa - Người Dùng</h1>
					</div>
					...
					<div class="row card-body">
						<form>
							...
							<!--       <div class="form-group">
                                ...
                                <label class="form-check form-check-inline" for="isadmin">
							...
							<div class="form-group">
								<label class="form-check form-check-inline"> <input
									class="form-check-input" type="radio" name="role" id="admin"
									value="true"> <span class="form-check-label">
										Admin </span>
								</label> <label class="form-check form-check-inline"> <input
									class="form-check-input" type="radio" name="role" id="user"
									value="false"> <span class="form-check-label">
										User</span>
								</label>
							</div>
							<!-- form-group end.// -->
							<div class="btn-group" role="group"
								...
								<button type="submit" class="btn btn-outline-primary"
									formaction="/admin/user/add">Thêm</button>
								<button type="submit" class="btn btn-outline-primary"
									formaction="/admin/delete">Xoá</button>
								<button type="submit" class="btn btn-outline-primary"
									formaction="/admin/update">Sửa</button>
						...
						<table id="example" class="display" style="width: 100%">
							...
							<tbody>
								<c:forEach items="${users}" var="item">
									<tr class="position-relative" style="color: black;">
										<td><a href="<c:url value=''/>"
											class="stretched-link text-decoration-none"
											style="color: black;">${item.username}</a></td>
										<td>${item.password}</td>
										<td>${item.email}</td>
										<td>${item.fullname}</td>
